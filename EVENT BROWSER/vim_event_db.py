...
# ── Database path ────────────────────────────────────────────────────────────
# Points at the existing SQLite file seeded by event_browser/backend/seed.py
_HERE = os.path.dirname(__file__)
_DB_PATH = os.path.join(_HERE, "..", "event_browser", "backend", "events.db")
...
# ── Event model (mirrors event_browser/backend/models.py) ────────────────────
def _gen_uuid():
